...
from synchroni_sensor_sdk.core.device import (
    BREATHE_PRODUCT_SPECIFICATION,
    GFORCE_OCT_PRODUCT_SPECIFICATION,
    GFORCE_PRO_PRODUCT_SPECIFICATION,
    NATIVE_DEVICE_PROFILES,
    NURA_NEO_PRODUCT_SPECIFICATION,
    NURA_OCTO_PRODUCT_SPECIFICATION,
    NURA_PENTO_PRODUCT_SPECIFICATION,
    NURA_PRODUCT_SPECIFICATION,
    NURA_TRIO_PRODUCT_SPECIFICATION,
    NURA_UNO_PRODUCT_SPECIFICATION,
    OB3000_PRODUCT_SPECIFICATION,
    ORION_A_PRODUCT_SPECIFICATION,
    ORION_B_PRODUCT_SPECIFICATION,
    ORION_C_PRODUCT_SPECIFICATION,
    ORION_PRODUCT_SPECIFICATION,
    OYWW1000_PRODUCT_SPECIFICATION,
    NativeDeviceProfile,
    ProductSpecification,
    SignalAcquisitionMode,
    native_device_profile,
    native_device_profile_by_id,
